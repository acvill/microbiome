#$ -S /bin/bash
#$ -N maxbin
#$ -e /workdir/users/agk85/press2/logs/maxbin_$JOB_ID.err
#$ -o /workdir/users/agk85/press2/logs/maxbin_$JOB_ID.out
#$ -t 1
#$ -V
...
R1=/workdir/data/press/metagenomes/merged/${NAME}.1.fastq
R2=/workdir/data/press/metagenomes/merged/${NAME}.2.fastq
#
