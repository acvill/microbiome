...
#########set variable things
folder='/workdir/users/agk85/press2/metaphlan'
infile='/workdir/users/agk85/press2/metaphlan/CDC+Healthy+Press_metaphlan.txt'
pairfile = '/workdir/users/agk85/press2/metaphlan/mgm_hic_pairs_cdc+healthy+press.csv'
...
keepers <- c("B370.1","B370.1hic","B370.2","B370.2hic","B370.3","B370.3hic",
	...
	"US2.1","US3.1","US5.1","US6.1","US7.1",
	"US2.1hic","US3.1hic","US5.1hic","US6.1hic","US7.1hic",
	"US3.5.hic.spikein")
#########
setwd(folder)
...
all_mgm_hic_healthy <- subset(all_mgm_hic, patient %in% c("US2","US3","US5","US6","US7"))
