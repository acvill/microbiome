...
DESIGN_FILE=${WRK}/TestDesign.txt
NAME=$(sed -n "${SGE_TASK_ID}p" $DESIGN_FILE)
LOG=/workdir/users/agk85/press2/phasegenomics/${NAME}_bwa_log.txt

/workdir/users/agk85/tools/bwa/bwa mem -t 8 -5SP /workdir/users/agk85/press2/hic/mapping/references/B310_scaffold /workdir/users/agk85/press2/fastqs/${NAME}.1.fastq /workdir/users/agk85/press2/fastqs/${NAME}.2.fastq | /programs/samblaster/samblaster | samtools view -S -h -b -F 2316 > /workdir/users/agk85/press2/phasegenomics/${NAME}_phasegenomics.bam 
...
/workdir/users/agk85/tools/bwa/bwa mem -t 8 -5SP /workdir/users/agk85/press2/hic/mapping/references/B310_scaffold /workdir/users/agk85/press2/fastqs/${NAME}.1.fastq /workdir/users/agk85/press2/fastqs/${NAME}.2.fastq | samtools view -S -h -b -F 2316 > /workdir/users/agk85/press2/phasegenomics/${NAME}_noblaster_phasegenomics.bam
