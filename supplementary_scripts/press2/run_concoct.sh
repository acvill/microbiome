#$ -S /bin/bash
#$ -N Concoct
#$ -e /workdir/users/agk85/press2/logs/concoct_$JOB_ID.err
#$ -o /workdir/users/agk85/press2/logs/concoct_$JOB_ID.out
#$ -t 1
#$ -V
...
#have to run this after metabat2 for the mapping files
