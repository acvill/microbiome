...
organisms = []
organisms2 = []
hicpaths = glob.glob(base + '/hic/mapping/*/*_trans_primary_' + pidthresh + '_noeuks.txt')
...
outhandle = base + '/hic/plotting/' + generalname + '_org_v_org_' + pidthresh + '.txt'
mismatchhandle = base + '/hic/plotting/' + generalname + '_org_v_org_' + pidthresh + '_mismatches_variablecount.txt'
...
header = header + '\n'
outhandle = base + '/hic/plotting/' + generalname + '_org_v_org_' + pidthresh + '_mge.txt'
with open(outhandle,'w') as outfile:
	outfile.write(header)
	for org1 in orglist:
		outfile.write(org1)
