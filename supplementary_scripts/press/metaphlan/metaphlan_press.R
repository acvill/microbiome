...
infile='/workdir/users/agk85/press/metaphlan/Press_metaphlan.txt'
pairfile = '/workdir/users/agk85/press/metaphlan/mgm_hic_pairs_press.csv'
generalname = 'Press'

#make sure it doesn't have profile stuff
...
keepers <-c("ProxiMeta.1","MluCI.1hic","Sau3aI.1hic")
#########
setwd(folder)
...
g<-ggplot(data=all_mgm_hic_both, aes(r,diff))+
	...
	scale_color_manual("Patient", values=c("deeppink","violetred2","red"))+
