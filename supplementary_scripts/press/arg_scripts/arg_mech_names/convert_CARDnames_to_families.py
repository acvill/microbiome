...
resfam_mechhandle = '/workdir/users/agk85/press/scripts/arg_scripts/arg_mech_names/all_hic_resfams_mech.txt'
card_mechhandle = '/workdir/users/agk85/press/scripts/arg_scripts/arg_mech_names/all_hic_card_mech.txt'


obofile ='/workdir/users/agk85/press/scripts/arg_scripts/arg_mech_names/aro.obo.agk'
resfams_metadata = '/workdir/users/agk85/press/scripts/arg_scripts/arg_mech_names/180102_resfams_metadata_updated_v1.2.2.txt'
megares_categories = '/workdir/users/agk85/press/scripts/arg_scripts/arg_mech_names/megares_annotations_v1.01.csv'
megares_maphandle = '/workdir/users/agk85/press/scripts/arg_scripts/arg_mech_names/megares_to_external_header_mappings_v1.01.tsv'
