...
#python arg_sample_rpkm.py /workdir/users/agk85/CDC/arg_v_org/mapping/metagenomes/bwa_alignments_95_95 /workdir/users/agk85/CDC/arg_v_org/mapping/metagenomes/bwa_alignments_95_95/arg_v_samp_95_95.txt /workdir/users/agk85/CDC/arg_v_org/mapping/metagenomes/bwa_alignments_95_95/arg_v_samp_95_95_names.txt CDC 
import glob
import collections
import sys
...
card_arg_name = folder + '/arg_v_org/metagenomes/card_prot_id_type.txt'
resfams_arg_name= folder + '/arg_v_org/metagenomes/resfams_prot_id_type.txt'
