...
#t2s = []
#for sample in samples:
#	if '-1' in sample[-2:] or '-8' in sample[-2:]: #
#		t1s.append(sample)
#	#else:
#	t2s.append(sample)
...
def get_connection_stats(t1,t2,connect1, connect2):
	...
	for connection in uniq2:
		if share_gene(t1,t2,connection) and share_taxa(t1,t2,connection):
			...
			uniqelement2 += 1		
	tup =(shared,uniqelement1,uniqelement2,unconnected1,unconnected2)
	return tup
	...
	for t1 in samples:
		...
		for t2 in samples:
			...
			if patient1 == patient2:
				...
				tott1 = len(connect1)
				tott2 = len(connect2)
				shared,uniqelement1, uniqelement2,unconnected1,unconnected2 =get_connection_stats(t1,t2,connect1, connect2)
