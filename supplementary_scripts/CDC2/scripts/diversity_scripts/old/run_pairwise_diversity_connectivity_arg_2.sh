...
SCRIPT=$WRK/scripts/diversity_scripts/pairwise_diversity_v_connectivity.py

CONNECTIONS=$WRK/bins/connections_${GENE}_org_all_${CONTACT_THRESH}.txt
OUTFILE=$WRK/bins/diversity_figures/${GENE}_${CONTACT_THRESH}_sample_pairwise_connection_counts.txt
