...
legend("topleft",cex=5,title="Patients",legend=c("None","1","2","3","4","5","6","7","8"),fill=colors)
...
for (i in 5:max(sub7_multipat$Patcount)-1){
	print(i)
...
colors <- c("white","purple","blue","lightblue","yellow","orange","orangered","red","pink")
heat.col = colors[0:max(subdata_multipat)+i]
