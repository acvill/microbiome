...
plasmids <- annotations$Plasmid_Finder + annotations$Full_Plasmids + annotations$Relaxase + annotations$Aclame_plasmid + annotations$Imme_plasmid + annotations$Plasmid_pfams + annotations$Mobile_pfams + annotations$Plasflow
...
bestorgname <-paste(amph$Best_org.amphora_rnammer.) #now kraken but i just didn't change the labels
