#$ -S /bin/bash
#$ -N maxbin
#$ -e /workdir/users/agk85/CDC2/logs/maxbin_with_$JOB_ID.err
#$ -o /workdir/users/agk85/CDC2/logs/maxbin_with_$JOB_ID.out
#$ -t 38-42
#$ -V
...
OUT=$WRK/maxbin_with/${NAME}
 if [ ! -d $OUT ]; then mkdir -p $OUT; fi

LOG=$WRK/logs/maxbin_with_$JOB_ID_${NAME}.out
