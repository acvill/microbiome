#$ -S /bin/bash
#$ -N checkm_das_with
#$ -e /workdir/users/agk85/CDC2/logs/das_checkm_with_$JOB_ID.err
#$ -o /workdir/users/agk85/CDC2/logs/das_checkm_with_$JOB_ID.out
#$ -t 1-43
#$ -V
...
FOLDER=$WRK/das_with/${NAME}/${NAME}_DASTool_bins
OUT=$WRK/das_with/${NAME}/checkm_lineage

 if [ ! -d $OUT ]; then mkdir -p $OUT; fi

LOG=$WRK/logs/das_checkm_with_$JOB_ID_${NAME}.out
