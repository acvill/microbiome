#$ -S /bin/bash
#$ -N isescan
#$ -e /workdir/users/agk85/CDC/iselements/log/isescan2_$JOB_ID.err
#$ -o /workdir/users/agk85/CDC/iselements/log/isescan2_$JOB_ID.out
#$ -t 1-19
#$ -tc 1
#$ -V
...
LOG=$WRK/iselements/log/isescan2_${NAME}_$JOB_ID.out
