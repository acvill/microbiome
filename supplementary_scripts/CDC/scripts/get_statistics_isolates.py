...
paths = glob.glob('/workdir/users/agk85/CDC/isolate_hgt/good+bad/*scaffold.fna')
...
outfile = open('/workdir/users/agk85/CDC/isolate_hgt/good+bad/statistics.txt','w')
