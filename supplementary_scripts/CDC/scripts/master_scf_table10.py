...
for id in ids:
	...
	add_program(linedict, imme_plasmid_dict, id, "plasmid_") #14
	add_program(linedict, imme_phage_dict, id, "phage_") #15
	add_program(linedict, imme_transposon_dict, id, "transposon_") #16
	add_program(linedict, imme_intron_dict, id, "intron_")#17
	add_program(linedict, imme_gi_dict, id, "gi_")#18	
	add_program(linedict, aclame_plasmid_dict, id, "plasmid_") #19
	add_program(linedict, aclame_phage_dict, id, "phage_") #20
	add_program(linedict, amphora_single_dict, id, "amphora_") #21
	add_program(linedict, rnammer_single_dict, id, "rnammer_") #22
	add_program(linedict, anvio_single_dict, id, "anvio_") # 23
	add_program(linedict, mtphln_single_dict,id, "mtphln_") #24
	add_program(linedict, gsmer_single_dict,id, "gsmer_") #25
	add_program(linedict, maxbin_dict, id, "maxbin_") #26
#write linedict
