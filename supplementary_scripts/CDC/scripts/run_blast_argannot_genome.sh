#$ -S /bin/bash
#$ -N argannotg
#$ -e /workdir/users/agk85/CDC/resfams/log/blast_argannotg_$JOB_ID.err
#$ -o /workdir/users/agk85/CDC/resfams/log/blast_argannotg_$JOB_ID.out
#$ -V
#$ -pe parenv 1
#$ -l h_vmem=2G
#$ -t 1-24
...
QUERY1=$WRK/prodigal/genomes/${NAME}/${NAME}_proteins.fna
QUERY2=$WRK/prodigal/genomes/${NAME}/${NAME}_proteins.faa
