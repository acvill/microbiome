...
#$ -N sort_bam_mge
#$ -V
#$ -o /workdir/users/agk85/CDC/mapping/log/sort_bam_mge_$JOB_ID.out #Location for stdout
#$ -e /workdir/users/agk85/CDC/mapping/log/sort_bam_mge_$JOB_ID.err #Location for stderr
