...
data <- read.table(paste(workdir, "/hic/mapping/", name,"/",name, "_trans_primary_", identity, ".txt",sep=""), sep="\t")
...
pdf(paste("HIC_trans_nicely_annot_withlink_", name,"_", identity, "_",cut.off, ".pdf",sep=""),height=100, width=100)
...
write.csv(df, paste("Gates_percent_capture_", identity, "id.csv",sep=""))
