...
# 21Other_pfams(name|start_stop_rpkm_covg)
# 22Amphora(best_taxonomy(confidence))
# 23Rnammer(taxa_pid_start_stop)
# 24Anvio(pid|taxa)
# 25Maxbin(bin_taxa_completeness_contamination)
# 26Best_org(amphora_rnammer)

outhandle = 'mge_org_counts.txt'
a=0
b=0
c=0
d=0
	...
	for inline in infile: 
		if inline[0] != 'S':
			...
			if fields[1] + fields[2] + fields[3] + fields[4] + fields[8] + fields[9] + fields[10] + fields[14] + fields[15] + fields[16] + fields[19] + fields[20]!= '000000000000':
				...
				if fields[27] != '0':
					bestorg +=1
			if fields[1] != '0' and fields[27]=='1':
				a +=1
			if fields[2] != '0'and fields[27]=='1':
				b +=1
			if fields[3] != '0'and fields[27]=='1':
				c +=1
			if fields[4] != '0'and fields[27]=='1':
				d +=1	
			if fields[8] != '0'and fields[27]=='1':
				e += 1
			if fields[9] != '0'and fields[27]=='1':
				f +=1
			if fields[10] != '0'and fields[27]=='1':
				g +=1
			if fields[14] != '0'and fields[27]=='1':
				h +=1
			if fields[15] != '0'and fields[27]=='1':
				i +=1
			if fields[16] != '0'and fields[27]=='1':
				j +=1
			if fields[19] != '0'and fields[27]=='1':
				k +=1
			if fields[20] != '0'and fields[27]=='1':
				l +=1
