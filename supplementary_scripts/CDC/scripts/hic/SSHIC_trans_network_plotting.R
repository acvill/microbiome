...
#load in data
identity=args[1]
df <- read.csv(paste("SSHIC_CDC_percent_capture_", identity,"id.csv",sep=""),row.names=1)
...
pdf(paste("SSHIC_Percent_capture_trans_", identity, "id_min_", cutoff, ".pdf",sep=""),height=7, width=10)
...
pdf(paste("SSHIC_Percent_capture_trans_boxplot_", identity, "id_min_", cutoff, ".pdf",sep=""),height=7, width=10)
...
pdf(paste("SSHIC_Percent_capture_trans_boxplot_ungrouped_", identity, "id_min_", cutoff, ".pdf",sep=""),height=7, width=5)
ggplot(df2, aes(type, mge_percents))+
