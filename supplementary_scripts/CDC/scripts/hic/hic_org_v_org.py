...
outhandle = base + '/newhic/plotting/CDC_org_v_org_' + pidthresh + '.txt'
mismatchhandle = base + '/newhic/plotting/CDC_org_v_org_' + pidthresh + '_mismatches_variablecount.txt'
...
header = header + '\n'
outhandle = base + '/newhic/plotting/CDC_org_v_org_' + pidthresh + '_mge.txt'
with open(outhandle,'w') as outfile:
	outfile.write(header)
	for org1 in orglist:
		outfile.write(org1)
