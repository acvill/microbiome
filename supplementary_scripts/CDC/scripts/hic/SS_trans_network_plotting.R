...
pdf(paste("Percent_capture_trans_boxplot_", identity, "id_min_", cutoff, ".pdf",sep=""),height=7, width=10)
...
pdf(paste("Percent_capture_trans_boxplot_ungrouped_", identity, "id_min_", cutoff, ".pdf",sep=""),height=7, width=5)
ggplot(df2, aes(type, mge_percents))+
