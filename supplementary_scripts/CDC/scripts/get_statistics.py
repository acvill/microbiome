...
paths = glob.glob('/workdir/users/agk85/CDC/idba_rerun/' + type + 's/scaffolds/*scaffold.fasta')
...
outfile = open('/workdir/users/agk85/CDC/idba_rerun/log/' + type + '_statistics.txt','w')
