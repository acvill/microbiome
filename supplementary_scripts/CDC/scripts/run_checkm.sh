...
FOLDER=$WRK/maxbin/metagenomes3/no_mges/${NAME}
OUT=$WRK/maxbin/metagenomes3/no_mges/${NAME}/checkm_lineage
...
checkm lineage_wf -t 8 -x fasta /workdir/users/agk85/CDC/maxbin/metagenomes3/no_mges/${NAME} $OUT
