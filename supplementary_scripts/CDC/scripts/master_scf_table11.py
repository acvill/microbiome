...
#Plasmid_pfams
with open('/workdir/users/agk85/CDC/plasmids/metagenomes2/' + name + '/' + name + '_plasmid_pfam.txt','r') as plasmid_pfams:
        plasmid_pfam_dict = {}
...
#other_pfams
with open('/workdir/users/agk85/CDC/annotation/metagenomes2/' + name + '_other_pfam.txt','r') as other_pfams:
	other_pfam_dict = {}
...
for id in ids:
	...
	add_program(linedict, plasmid_pfam_dict, id, "plasmid_")#5
	...
	add_program(linedict, imme_plasmid_dict, id, "plasmid_") #15
	add_program(linedict, imme_phage_dict, id, "phage_") #16
	...
	add_program(linedict, aclame_plasmid_dict, id, "plasmid_") #20
	add_program(linedict, aclame_phage_dict, id, "phage_") #21
	...
	add_program(linedict, anvio_single_dict, id, "anvio_") # 25
	add_program(linedict, mtphln_single_dict,id, "mtphln_") #26
	add_program(linedict, gsmer_single_dict,id, "gsmer_") #27
	add_program(linedict, maxbin_dict, id, "maxbin_") #28
#write linedict
