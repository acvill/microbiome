...
WRK='/workdir/users/agk85/CDC'
transpaths = glob.glob(WRK + '/newhic/mapping_mgm/*/*_trans_primary_98_sub.txt')
...
inhandle = WRK + '/newhic/mapping_mgm/trans_primary_ncol_98.txt'
outhandle = WRK+'/newhic/mapping_mgm/trans_primary_ncol_98_noeuks.txt'
deleted_trans = WRK+'/newhic/mapping_mgm/trans_primary_ncol_98_euks.txt'
