...
for id in ids:
	...
	if ((fields[1] + fields[2] + fields[3] + fields[4] + fields[8] + fields[9] + fields[10] + fields[14] + fields[15] + fields[16] + fields[19] + fields[20]) == '............') and ('Viruses' not in bestorg):
...
outfile = open('/workdir/users/agk85/CDC/combo_tables/metagenomes15temp/' + name + '_master_scf_table.txt','w')
eukfile = open('/workdir/users/agk85/CDC/combo_tables/metagenomes15temp/' + name + '_euk.txt','w')
