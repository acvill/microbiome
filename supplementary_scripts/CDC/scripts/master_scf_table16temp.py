...
outfile = open('/workdir/users/agk85/CDC/combo_tables/metagenomes16temp/' + name + '_master_scf_table.txt','w')
eukfile = open('/workdir/users/agk85/CDC/combo_tables/metagenomes16temp/' + name + '_euk.txt','w')
