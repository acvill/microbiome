...
for id in ids:
	...
	add_program(linedict, amphora_single_dict, id, "amphora_") #17
	add_program(linedict, rnammer_single_dict, id, "rnammer_") #18
	add_program(linedict, anvio_single_dict, id, "anvio_") # 19
	add_program(linedict, mtphln_single_dict,id, "mtphln_") #20
	add_program(linedict, gsmer_single_dict,id, "gsmer_") #22
